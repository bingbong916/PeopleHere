...
public class ReviewController {
    ...
    @PostMapping("/new")
    public BaseResponse<GetReviewResponse> addReview(@RequestBody PostReviewRequest request) {
    ...
    @PutMapping("/{id}")
    public BaseResponse<GetReviewResponse> updateReview(@PathVariable Long id, @RequestBody PutReviewRequest request) {
